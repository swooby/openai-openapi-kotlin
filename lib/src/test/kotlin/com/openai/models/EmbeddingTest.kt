...
class EmbeddingTest : ShouldSpec() {
    init {
        ...
        // to test the property `index` - The index of the embedding in the list
        // of embeddings.
        should("test index") {
        ...
        // to test the property `embedding` - The embedding vector, which is a
        // list of floats. The length of vector depends on the model as listed
