...
class VectorStoreObjectTest : ShouldSpec() {
    init {
        ...
        // to test the property `usageBytes` - The total number of bytes used by
        // the files in the vector store.
        ...
        // to test the property `status` - The status of the vector store, which
        // can be either `expired`, `in_progress`, or `completed`. A status of
        ...
        // to test the property `lastActiveAt` - The Unix timestamp (in seconds)
        // for when the vector store was last active.
        ...
        // for when the vector store will expire.
