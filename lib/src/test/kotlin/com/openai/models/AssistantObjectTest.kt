...
class AssistantObjectTest : ShouldSpec() {
    init {
        ...
        // to test the property `name` - The name of the assistant. The maximum
        ...
        // to test the property `description` - The description of the
        // assistant. The maximum length is 512 characters.
        should("test description") {
            // uncomment below to test the property
            // modelInstance.description shouldBe ("TODO")
        }

        // to test the property `model` - ID of the model to use. You can use
        // the [List models](/docs/api-reference/models/list) API to see all of
        ...
        // to test the property `instructions` - The system instructions that
        ...
        // to test the property `tools` - A list of tool enabled on the
