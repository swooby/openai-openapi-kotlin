...
class UsageTimeBucketResultInnerTest : ShouldSpec() {
    init {
        ...
        // to test the property `inputTokens` - The aggregated number of input
        // tokens used.
        ...
        // to test the property `outputTokens` - The aggregated number of text
        // output tokens used. For customers subscribe to scale tier, this
        ...
        // to test the property `characters` - The number of characters
        // processed.
        ...
        // to test the property `inputCachedTokens` - The aggregated number of
        // text input tokens that has been cached from previous requests. For
        ...
        // to test the property `inputAudioTokens` - The aggregated number of
        // audio input tokens used, including cached tokens.
        should("test inputAudioTokens") {
            // uncomment below to test the property
            // modelInstance.inputAudioTokens shouldBe ("TODO")
        }

        // to test the property `outputAudioTokens` - The aggregated number of
        // audio output tokens used.
        ...
        // field provides the project ID of the grouped costs result.
        ...
        // to test the property `batch` - When `group_by=batch`, this field
        // tells whether the grouped usage result is batch or not.
        should("test batch") {
            // uncomment below to test the property
        ...
        // to test the property `numSessions` - The number of code interpreter
        // sessions.
        should("test numSessions") {
            // uncomment below to test the property
            // modelInstance.numSessions shouldBe ("TODO")
        }
        ...
        // to test the property `lineItem` - When `group_by=line_item`, this
        // field provides the line item of the grouped costs result.
