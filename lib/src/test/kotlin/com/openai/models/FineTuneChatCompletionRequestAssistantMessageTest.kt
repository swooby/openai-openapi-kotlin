...
class FineTuneChatCompletionRequestAssistantMessageTest : ShouldSpec() {
    init {
        ...
        // to test the property `name` - An optional name for the participant.
        // Provides the model information to differentiate between participants
        // of the same role.
        should("test name") {
            // uncomment below to test the property
        ...
        // to test the property `weight` - Controls whether the assistant
        // message is trained against (0 or 1)
        should("test weight") {
            // uncomment below to test the property
