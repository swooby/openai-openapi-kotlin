...
class CreateChatCompletionStreamResponseTest : ShouldSpec() {
    init {
        ...
        // completion. Each chunk has the same ID.
        should("test id") {
        ...
        // Can contain more than one elements if `n` is greater than 1. Can also
        // be empty for the last chunk if you set `stream_options:
        // {\"include_usage\": true}`.
        should("test choices") {
            // uncomment below to test the property
        ...
        // when the chat completion was created. Each chunk has the same
        // timestamp.
        should("test created") {
            // uncomment below to test the property
        ...
        // represents the backend configuration that the model runs with. Can be
        // used in conjunction with the `seed` request parameter to understand
