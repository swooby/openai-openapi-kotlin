...
class TranscriptionSegmentTest : ShouldSpec() {
    init {
        ...
        // to test the property `tokens` - Array of token IDs for the text
        // content.
        should("test tokens") {
            // uncomment below to test the property
        ...
        // to test the property `temperature` - Temperature parameter used for
        ...
        // to test the property `avgLogprob` - Average logprob of the segment.
        ...
        // to test the property `compressionRatio` - Compression ratio of the
        // segment. If the value is greater than 2.4, consider the compression
        // failed.
        ...
        // to test the property `noSpeechProb` - Probability of no speech in the
        // segment. If the value is higher than 1.0 and the `avg_logprob` is
