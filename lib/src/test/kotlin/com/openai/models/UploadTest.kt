...
class UploadTest : ShouldSpec() {
    init {
        ...
        // to test the property `id` - The Upload unique identifier, which can
        ...
        // to test the property `filename` - The name of the file to be
        // uploaded.
        ...
        // to test the property `bytes` - The intended number of bytes to be
        // uploaded.
        should("test bytes") {
            // uncomment below to test the property
