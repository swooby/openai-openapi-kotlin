...
class UpdateChatCompletionRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UpdateChatCompletionRequest
        // val modelInstance = UpdateChatCompletionRequest()
