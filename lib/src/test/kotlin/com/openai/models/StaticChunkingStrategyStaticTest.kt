...
class StaticChunkingStrategyStaticTest : ShouldSpec() {
    init {
        ...
        // to test the property `maxChunkSizeTokens` - The maximum number of
        // tokens in each chunk. The default value is `800`. The minimum value
        ...
        // to test the property `chunkOverlapTokens` - The number of tokens that
        // overlap between chunks. The default value is `400`.  Note that the
