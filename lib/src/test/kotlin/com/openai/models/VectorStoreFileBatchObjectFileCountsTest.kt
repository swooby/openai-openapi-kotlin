...
class VectorStoreFileBatchObjectFileCountsTest : ShouldSpec() {
    init {
        ...
        // to test the property `inProgress` - The number of files that are
        ...
        // to test the property `completed` - The number of files that have been
        // processed.
        ...
        // to test the property `failed` - The number of files that have failed
        // to process.
        should("test failed") {
            // uncomment below to test the property
        ...
        // to test the property `cancelled` - The number of files that where
        // cancelled.
