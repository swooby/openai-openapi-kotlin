...
class ProjectRateLimitTest : ShouldSpec() {
    init {
        ...
        // to test the property `maxRequestsPer1Minute` - The maximum requests
        // per minute.
        ...
        // to test the property `maxTokensPer1Minute` - The maximum tokens per
        // minute.
        ...
        // to test the property `maxImagesPer1Minute` - The maximum images per
        ...
        // to test the property `maxAudioMegabytesPer1Minute` - The maximum
        // audio megabytes per minute. Only present for relevant models.
        should("test maxAudioMegabytesPer1Minute") {
            // uncomment below to test the property
            // modelInstance.maxAudioMegabytesPer1Minute shouldBe ("TODO")
        }

        // to test the property `maxRequestsPer1Day` - The maximum requests per
        // day. Only present for relevant models.
        should("test maxRequestsPer1Day") {
            // uncomment below to test the property
            // modelInstance.maxRequestsPer1Day shouldBe ("TODO")
        }

        // to test the property `batch1DayMaxInputTokens` - The maximum batch
        // input tokens per day. Only present for relevant models.
