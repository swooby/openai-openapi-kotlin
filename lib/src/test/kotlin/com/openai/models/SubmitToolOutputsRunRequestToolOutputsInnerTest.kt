...
class SubmitToolOutputsRunRequestToolOutputsInnerTest : ShouldSpec() {
    init {
        ...
        // to test the property `toolCallId` - The ID of the tool call in the
        // `required_action` object within the run object the output is being
        // submitted for.
        ...
        // to test the property `output` - The output of the tool call to be
