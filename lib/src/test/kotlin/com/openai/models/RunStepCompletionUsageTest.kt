...
class RunStepCompletionUsageTest : ShouldSpec() {
    init {
        ...
        // to test the property `completionTokens` - Number of completion tokens
        // used over the course of the run step.
        should("test completionTokens") {
            // uncomment below to test the property
            // modelInstance.completionTokens shouldBe ("TODO")
        }

        // to test the property `promptTokens` - Number of prompt tokens used
        // over the course of the run step.
        should("test promptTokens") {
            // uncomment below to test the property
            // modelInstance.promptTokens shouldBe ("TODO")
        }

        // to test the property `totalTokens` - Total number of tokens used
        // (prompt + completion).
