...
class ChatCompletionTokenLogprobTest : ShouldSpec() {
    init {
        ...
        // if it is within the top 20 most likely tokens. Otherwise, the value
        ...
        // to test the property `bytes` - A list of integers representing the
        // UTF-8 bytes representation of the token. Useful in instances where
        ...
        // representation. Can be `null` if there is no bytes representation for
        // the token.
        should("test bytes") {
            // uncomment below to test the property
        ...
        // to test the property `topLogprobs` - List of the most likely tokens
        // and their log probability, at this token position. In rare cases,
        // there may be fewer than the number of requested `top_logprobs`
        // returned.
