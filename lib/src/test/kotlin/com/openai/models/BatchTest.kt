...
class BatchTest : ShouldSpec() {
    init {
        ...
        // to test the property `endpoint` - The OpenAI API endpoint used by the
        // batch.
        ...
        // to test the property `inputFileId` - The ID of the input file for the
        // batch.
        ...
        // to test the property `outputFileId` - The ID of the file containing
        // the outputs of successfully executed requests.
        should("test outputFileId") {
            // uncomment below to test the property
            // modelInstance.outputFileId shouldBe ("TODO")
        }

        // to test the property `errorFileId` - The ID of the file containing
        // the outputs of requests with errors.
        should("test errorFileId") {
            // uncomment below to test the property
            // modelInstance.errorFileId shouldBe ("TODO")
        }

        // to test the property `inProgressAt` - The Unix timestamp (in seconds)
        // for when the batch started processing.
        ...
        // to test the property `finalizingAt` - The Unix timestamp (in seconds)
        // for when the batch started finalizing.
        ...
        // for when the batch was completed.
        ...
        // to test the property `expiredAt` - The Unix timestamp (in seconds)
        ...
        // to test the property `cancellingAt` - The Unix timestamp (in seconds)
        // for when the batch started cancelling.
        ...
        // for when the batch was cancelled.
