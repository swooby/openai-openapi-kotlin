...
class RunStepObjectTest : ShouldSpec() {
    init {
        ...
        // to test the property `id` - The identifier of the run step, which can
        ...
        // for when the run step was created.
        ...
        // [assistant](/docs/api-reference/assistants) associated with the run
        // step.
        ...
        // to test the property `runId` - The ID of the
        // [run](/docs/api-reference/runs) that this run step is a part of.
        should("test runId") {
            // uncomment below to test the property
            // modelInstance.runId shouldBe ("TODO")
        }

        // to test the property `type` - The type of run step, which can be
        // either `message_creation` or `tool_calls`.
        should("test type") {
            // uncomment below to test the property
            // modelInstance.type shouldBe ("TODO")
        }

        // to test the property `status` - The status of the run step, which can
        // be either `in_progress`, `cancelled`, `failed`, `completed`, or
        // `expired`.
        should("test status") {
            // uncomment below to test the property
        ...
        // for when the run step expired. A step is considered expired if the
        ...
        // for when the run step was cancelled.
