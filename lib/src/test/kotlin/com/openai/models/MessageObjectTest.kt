...
class MessageObjectTest : ShouldSpec() {
    init {
        ...
        // to test the property `threadId` - The
        // [thread](/docs/api-reference/threads) ID that this message belongs
        // to.
        ...
        // to test the property `status` - The status of the message, which can
        // be either `in_progress`, `incomplete`, or `completed`.
        should("test status") {
            // uncomment below to test the property
        ...
        // for when the message was completed.
        should("test completedAt") {
            // uncomment below to test the property
            // modelInstance.completedAt shouldBe ("TODO")
        }

        // to test the property `incompleteAt` - The Unix timestamp (in seconds)
        // for when the message was marked as incomplete.
        ...
        // [run](/docs/api-reference/runs) associated with the creation of this
