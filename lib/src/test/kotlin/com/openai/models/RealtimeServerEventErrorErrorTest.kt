...
class RealtimeServerEventErrorErrorTest : ShouldSpec() {
    init {
        ...
        // to test the property `type` - The type of error (e.g.,
        ...
        // to test the property ``param`` - Parameter related to the error, if
        // any.
        should("test `param`") {
            // uncomment below to test the property
        ...
        // to test the property `eventId` - The event_id of the client event
