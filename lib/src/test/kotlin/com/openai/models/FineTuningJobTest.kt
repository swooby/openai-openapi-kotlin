...
class FineTuningJobTest : ShouldSpec() {
    init {
        ...
        // to test the property `id` - The object identifier, which can be
        ...
        // to test the property `fineTunedModel` - The name of the fine-tuned
        // model that is being created. The value will be null if the
        ...
        // to test the property `finishedAt` - The Unix timestamp (in seconds)
        // for when the fine-tuning job was finished. The value will be null if
        ...
        // to test the property `model` - The base model that is being
        // fine-tuned.
        should("test model") {
            // uncomment below to test the property
        ...
        // to test the property `organizationId` - The organization that owns
        // the fine-tuning job.
        ...
        // to test the property `resultFiles` - The compiled results file ID(s)
        // for the fine-tuning job. You can retrieve the results with the [Files
        ...
        // to test the property `status` - The current status of the fine-tuning
        // job, which can be either `validating_files`, `queued`, `running`,
        ...
        // to test the property `trainedTokens` - The total number of billable
        // tokens processed by this fine-tuning job. The value will be null if
        // the fine-tuning job is still running.
        ...
        // to test the property `trainingFile` - The file ID used for training.
        // You can retrieve the training data with the [Files
        // API](/docs/api-reference/files/retrieve-contents).
        ...
        // to test the property `validationFile` - The file ID used for
        // validation. You can retrieve the validation results with the [Files
        // API](/docs/api-reference/files/retrieve-contents).
        ...
        // enable for this fine-tuning job.
        should("test integrations") {
            // uncomment below to test the property
            // modelInstance.integrations shouldBe ("TODO")
        }

        // to test the property `estimatedFinish` - The Unix timestamp (in
        // seconds) for when the fine-tuning job is estimated to finish. The
