...
class FunctionObjectTest : ShouldSpec() {
    init {
        ...
        // to test the property `name` - The name of the function to be called.
        ...
        // function does, used by the model to choose when and how to call the
        // function.
        ...
        // to test the property `parameters` - The parameters the functions
        // accepts, described as a JSON Schema object. See the
        // [guide](/docs/guides/function-calling) for examples, and the [JSON
        ...
        // Learn more about Structured Outputs in the [function calling
