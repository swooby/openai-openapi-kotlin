...
class CompletionUsageCompletionTokensDetailsTest : ShouldSpec() {
    init {
        ...
        // to test the property `acceptedPredictionTokens` - When using
        // Predicted Outputs, the number of tokens in the prediction that
        ...
        // to test the property `audioTokens` - Audio input tokens generated by
        // the model.
        ...
        // to test the property `reasoningTokens` - Tokens generated by the
        // model for reasoning.
        ...
        // to test the property `rejectedPredictionTokens` - When using
        // Predicted Outputs, the number of tokens in the prediction that did
        // not appear in the completion. However, like reasoning tokens, these
        // tokens are still counted in the total completion tokens for purposes
