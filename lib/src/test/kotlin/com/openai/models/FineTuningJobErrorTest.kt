...
class FineTuningJobErrorTest : ShouldSpec() {
    init {
        ...
        // to test the property ``param`` - The parameter that was invalid,
        // usually `training_file` or `validation_file`. This field will be null
        // if the failure was not parameter-specific.
        should("test `param`") {
            // uncomment below to test the property
