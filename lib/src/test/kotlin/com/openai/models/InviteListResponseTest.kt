...
class InviteListResponseTest : ShouldSpec() {
    init {
        ...
        // to test the property `firstId` - The first `invite_id` in the
        // retrieved `list`
        should("test firstId") {
            // uncomment below to test the property
        ...
        // to test the property `lastId` - The last `invite_id` in the retrieved
        // `list`
        should("test lastId") {
            // uncomment below to test the property
        ...
        // to test the property `hasMore` - The `has_more` property is used for
        // pagination to indicate there are additional results.
        should("test hasMore") {
            // uncomment below to test the property
