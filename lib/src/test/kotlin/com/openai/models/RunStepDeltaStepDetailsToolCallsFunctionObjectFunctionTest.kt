...
class RunStepDeltaStepDetailsToolCallsFunctionObjectFunctionTest :
    ...
    init {
        ...
        // to test the property `arguments` - The arguments passed to the
        // function.
        ...
        // to test the property `output` - The output of the function. This will
        // be `null` if the outputs have not been
