...
class InvitesApiTest : ShouldSpec() {
    init {
        ...
        should("test deleteInvite") {
            ...
            // val result : InviteDeleteResponse =
            // apiInstance.deleteInvite(inviteId)
        ...
        should("test inviteUser") {
            ...
            // val inviteRequest : InviteRequest =  // InviteRequest | The
        ...
        should("test listInvites") {
            ...
            // val result : InviteListResponse = apiInstance.listInvites(limit,
            // after)
            // result shouldBe ("TODO")
        }
