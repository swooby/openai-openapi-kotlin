...
class ProjectsApiTest : ShouldSpec() {
    init {
        ...
        should("test archiveProject") {
            ...
            // kotlin.String | The ID of the project.
        ...
        should("test createProject") {
            ...
            // val result : Project =
            // apiInstance.createProject(projectCreateRequest)
            // result shouldBe ("TODO")
        }
        ...
        should("test createProjectServiceAccount") {
            ...
            // val projectId : kotlin.String = projectId_example //
            // kotlin.String | The ID of the project.
            // val projectServiceAccountCreateRequest :
            // ProjectServiceAccountCreateRequest =  //
            // ProjectServiceAccountCreateRequest | The project service account
            // create request payload.
            // val result : ProjectServiceAccountCreateResponse =
            // apiInstance.createProjectServiceAccount(projectId,
            // projectServiceAccountCreateRequest)
            // result shouldBe ("TODO")
        }
        ...
        should("test createProjectUser") {
            ...
            // val projectId : kotlin.String = projectId_example //
            // kotlin.String | The ID of the project.
            // val projectUserCreateRequest : ProjectUserCreateRequest =  //
            // ProjectUserCreateRequest | The project user create request
            // payload.
            // val result : ProjectUser =
            // apiInstance.createProjectUser(projectId,
        ...
        should("test deleteProjectApiKey") {
            ...
            // val projectId : kotlin.String = projectId_example //
            // kotlin.String | The ID of the project.
            // val keyId : kotlin.String = keyId_example // kotlin.String | The
            // ID of the API key.
            // val result : ProjectApiKeyDeleteResponse =
            // apiInstance.deleteProjectApiKey(projectId, keyId)
            // result shouldBe ("TODO")
        }
        ...
        should("test deleteProjectServiceAccount") {
            ...
            // val projectId : kotlin.String = projectId_example //
            // kotlin.String | The ID of the project.
            // val serviceAccountId : kotlin.String = serviceAccountId_example
            // // kotlin.String | The ID of the service account.
            // val result : ProjectServiceAccountDeleteResponse =
            // apiInstance.deleteProjectServiceAccount(projectId,
            // serviceAccountId)
            // result shouldBe ("TODO")
        }
        ...
        should("test deleteProjectUser") {
            ...
            // The ID of the user.
            // val result : ProjectUserDeleteResponse =
            // apiInstance.deleteProjectUser(projectId, userId)
            // result shouldBe ("TODO")
        }
        ...
        should("test listProjectApiKeys") {
            ...
            // val result : ProjectApiKeyListResponse =
            // apiInstance.listProjectApiKeys(projectId, limit, after)
            // result shouldBe ("TODO")
        }
        ...
        should("test listProjectRateLimits") {
            ...
            // kotlin.String | The ID of the project.
            // val limit : kotlin.Int = 56 // kotlin.Int | A limit on the number
            // of objects to be returned. The default is 100.
            // val after : kotlin.String = after_example // kotlin.String | A
            // cursor for use in pagination. `after` is an object ID that
            // defines your place in the list. For instance, if you make a list
            // request and receive 100 objects, ending with obj_foo, your
            ...
            // val result : ProjectRateLimitListResponse =
            // apiInstance.listProjectRateLimits(projectId, limit, after,
            // before)
            // result shouldBe ("TODO")
        }
        ...
        should("test listProjectServiceAccounts") {
            ...
            // subsequent call can include after=obj_foo in order to fetch the
            // next page of the list.
            // val result : ProjectServiceAccountListResponse =
            // apiInstance.listProjectServiceAccounts(projectId, limit, after)
            // result shouldBe ("TODO")
        }
        ...
        should("test listProjectUsers") {
            ...
            // subsequent call can include after=obj_foo in order to fetch the
            // next page of the list.
            // val result : ProjectUserListResponse =
            // apiInstance.listProjectUsers(projectId, limit, after)
            // result shouldBe ("TODO")
        }
        ...
        should("test listProjects") {
            ...
            // val result : ProjectListResponse =
            // apiInstance.listProjects(limit, after, includeArchived)
            // result shouldBe ("TODO")
        }
        ...
        should("test modifyProject") {
            ...
            // val result : Project = apiInstance.modifyProject(projectId,
        ...
        should("test modifyProjectUser") {
            ...
            // val userId : kotlin.String = userId_example // kotlin.String |
            // The ID of the user.
            // val projectUserUpdateRequest : ProjectUserUpdateRequest =  //
            // ProjectUserUpdateRequest | The project user update request
            // payload.
            // val result : ProjectUser =
            // apiInstance.modifyProjectUser(projectId, userId,
        ...
        should("test retrieveProjectApiKey") {
            ...
            // val keyId : kotlin.String = keyId_example // kotlin.String | The
            // ID of the API key.
            // val result : ProjectApiKey =
            // apiInstance.retrieveProjectApiKey(projectId, keyId)
            // result shouldBe ("TODO")
        }
        ...
        should("test retrieveProjectServiceAccount") {
            ...
            // val serviceAccountId : kotlin.String = serviceAccountId_example
            // // kotlin.String | The ID of the service account.
            // val result : ProjectServiceAccount =
            // apiInstance.retrieveProjectServiceAccount(projectId,
            // serviceAccountId)
            // result shouldBe ("TODO")
        }
        ...
        should("test retrieveProjectUser") {
            ...
            // The ID of the user.
            // val result : ProjectUser =
            // apiInstance.retrieveProjectUser(projectId, userId)
            // result shouldBe ("TODO")
        }
        ...
        should("test updateProjectRateLimits") {
            ...
            // val projectId : kotlin.String = projectId_example //
            // kotlin.String | The ID of the project.
            // val rateLimitId : kotlin.String = rateLimitId_example //
            // kotlin.String | The ID of the rate limit.
            // val projectRateLimitUpdateRequest : ProjectRateLimitUpdateRequest
            // =  // ProjectRateLimitUpdateRequest | The project rate limit
            // update request payload.
            // val result : ProjectRateLimit =
            // apiInstance.updateProjectRateLimits(projectId, rateLimitId,
