...
class AudioApiTest : ShouldSpec() {
    init {
        ...
        should("test createSpeech") {
            ...
            // val createSpeechRequest : CreateSpeechRequest =  //
            // CreateSpeechRequest |
            // val result : java.io.File =
        ...
        should("test createTranscription") {
            ...
            // audio file object (not file name) to transcribe, in one of these
            ...
            // granularities to populate for this transcription.
        ...
        should("test createTranslation") {
            ...
            // automatically increase the temperature until certain thresholds
            // are hit.
            // val result : CreateTranslation200Response =
            // apiInstance.createTranslation(file, model, prompt,
