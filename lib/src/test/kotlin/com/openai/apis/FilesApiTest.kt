...
class FilesApiTest : ShouldSpec() {
    init {
        ...
        should("test createFile") {
            ...
            // File object (not file name) to be uploaded.
            // val purpose : kotlin.String = purpose_example // kotlin.String |
            // The intended purpose of the uploaded file. One of: -
            // `assistants`: Used in the Assistants API - `batch`: Used in the
            // Batch API - `fine-tune`: Used for fine-tuning - `vision`: Images
            // used for vision fine-tuning - `user_data`: Flexible file type for
        ...
        should("test listFiles") {
            ...
            // of objects to be returned. Limit can range between 1 and 10,000,
