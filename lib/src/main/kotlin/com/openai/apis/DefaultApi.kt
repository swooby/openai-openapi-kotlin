...
class DefaultApi(
    ...
    fun adminApiKeysCreate(
        ...
        val localVarResponse =
            adminApiKeysCreateWithHttpInfo(
                adminApiKeysCreateRequest = adminApiKeysCreateRequest
            )

        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as AdminApiKey
    ...
    fun adminApiKeysCreateWithHttpInfo(
        adminApiKeysCreateRequest: AdminApiKeysCreateRequest
    ): ApiResponse<AdminApiKey?> {
        val localVariableConfig =
            adminApiKeysCreateRequestConfig(
                adminApiKeysCreateRequest = adminApiKeysCreateRequest
            )
     ...
     */
    fun adminApiKeysCreateRequestConfig(
        adminApiKeysCreateRequest: AdminApiKeysCreateRequest
    ): RequestConfig<AdminApiKeysCreateRequest> {
     ...
     * @return RequestConfig
     */
    fun adminApiKeysDeleteRequestConfig(
        keyId: kotlin.String
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun adminApiKeysGetWithHttpInfo(
        keyId: kotlin.String
    ): ApiResponse<AdminApiKey?> {
        val localVariableConfig = adminApiKeysGetRequestConfig(keyId = keyId)

        return request<Unit, AdminApiKey>(localVariableConfig)
    }
     ...
     * @return RequestConfig
     */
    fun adminApiKeysGetRequestConfig(
        keyId: kotlin.String
    ): RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
    ...
    fun adminApiKeysList(
        ...
        order: OrderAdminApiKeysList? = OrderAdminApiKeysList.asc,
        limit: kotlin.Int? = 20,
    ): ApiKeyList {
        val localVarResponse =
            adminApiKeysListWithHttpInfo(
                after = after,
                order = order,
                limit = limit,
            )
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ApiKeyList
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun adminApiKeysListWithHttpInfo(
        after: kotlin.String?,
        order: OrderAdminApiKeysList?,
        limit: kotlin.Int?,
        ...
        return request<Unit, ApiKeyList>(localVariableConfig)
    }
     ...
     * @return RequestConfig
     */
    fun adminApiKeysListRequestConfig(
        after: kotlin.String?,
        order: OrderAdminApiKeysList?,
        limit: kotlin.Int?,
    ): RequestConfig<Unit> {
