...
class ModelsApi(
    ...
    fun deleteModel(model: kotlin.String): DeleteModelResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as DeleteModelResponse
        ...
        return RequestConfig(
            ...
            path =
                "/models/{model}"
                    .replace(
                        "{" + "model" + "}",
                        encodeURIComponent(model.toString()),
                    ),
    ...
    fun listModels(): ListModelsResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ListModelsResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun retrieveModel(model: kotlin.String): Model {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as Model
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
