...
import com.openai.models.CreateImageEditRequestModel
...
class ImagesApi(
    ...
    fun createImage(createImageRequest: CreateImageRequest): ImagesResponse {
        val localVarResponse =
            createImageWithHttpInfo(createImageRequest = createImageRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ImagesResponse
    ...
    fun createImageWithHttpInfo(
        ...
        val localVariableConfig =
            createImageRequestConfig(createImageRequest = createImageRequest)
     ...
     * @param prompt A text description of the desired image(s). The maximum
     *   length is 1000 characters.
     * @param mask An additional image whose fully transparent areas (e.g. where
     ...
     * @param size The size of the generated images. Must be one of
     *   &#x60;256x256&#x60;, &#x60;512x512&#x60;, or &#x60;1024x1024&#x60;.
     *   (optional, default to 1024x1024)
     * @param responseFormat The format in which the generated images are
     *   returned. Must be one of &#x60;url&#x60; or &#x60;b64_json&#x60;. URLs
     *   are only valid for 60 minutes after the image has been generated.
     *   (optional, default to url)
     * @param user A unique identifier representing your end-user, which can
    ...
    fun createImageEdit(
        ...
        size: PropertySizeCreateImageEdit? =
            PropertySizeCreateImageEdit._1024x1024,
        responseFormat: ResponseFormatCreateImageEdit? =
            ResponseFormatCreateImageEdit.url,
    ...
    fun createImageEditRequestConfig(
        ...
        val localVariableBody =
            mapOf(
                ...
                "size" to
                    PartConfig(body = size?.value, headers = mutableMapOf()),
                "response_format" to
                    PartConfig(
     ...
     * @param model (optional)
     * @param n The number of images to generate. Must be between 1 and 10. For
    ...
    fun createImageVariation(
        ...
        responseFormat: ResponseFormatCreateImageVariation? =
            ResponseFormatCreateImageVariation.url,
        size: PropertySizeCreateImageVariation? =
            PropertySizeCreateImageVariation._1024x1024,
        user: kotlin.String? = null,
    ): ImagesResponse {
        val localVarResponse =
