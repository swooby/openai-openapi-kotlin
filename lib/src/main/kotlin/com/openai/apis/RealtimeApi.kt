...
class RealtimeApi(
    ...
    fun createRealtimeSession(
        ...
        val localVarResponse =
            createRealtimeSessionWithHttpInfo(
                realtimeSessionCreateRequest = realtimeSessionCreateRequest
            )
    ...
    fun createRealtimeSessionWithHttpInfo(
        realtimeSessionCreateRequest: RealtimeSessionCreateRequest
    ): ApiResponse<RealtimeSessionCreateResponse?> {
        val localVariableConfig =
            createRealtimeSessionRequestConfig(
                realtimeSessionCreateRequest = realtimeSessionCreateRequest
            )
     ...
     */
    fun createRealtimeSessionRequestConfig(
        realtimeSessionCreateRequest: RealtimeSessionCreateRequest
    ): RequestConfig<RealtimeSessionCreateRequest> {
