...
class AssistantsApi(
    ...
    fun cancelRun(threadId: kotlin.String, runId: kotlin.String): RunObject {
        val localVarResponse =
            cancelRunWithHttpInfo(threadId = threadId, runId = runId)

        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as RunObject
    ...
    fun cancelRunWithHttpInfo(
        ...
        val localVariableConfig =
            cancelRunRequestConfig(threadId = threadId, runId = runId)
        ...
        return RequestConfig(
            ...
            path =
                "/threads/{thread_id}/runs/{run_id}/cancel"
                    .replace(
                        "{" + "thread_id" + "}",
                        encodeURIComponent(threadId.toString()),
                    )
                    .replace(
                        "{" + "run_id" + "}",
                        encodeURIComponent(runId.toString()),
                    ),
    ...
    fun createAssistant(
        ...
        val localVarResponse =
            createAssistantWithHttpInfo(
                createAssistantRequest = createAssistantRequest
            )

        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as AssistantObject
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun createMessage(
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as MessageObject
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    enum class IncludeCreateRun(val value: kotlin.String) {
        @Json(
            name = "step_details.tool_calls[*].file_search.results[*].content"
        )
        step_detailsPeriodTool_callsLeft_Square_BracketStarRight_Square_BracketPeriodFile_searchPeriodResultsLeft_Square_BracketStarRight_Square_BracketPeriodContent(
     ...
     *   &#x60;step_details.tool_calls[*].file_search.results[*].content&#x60;
     *   to fetch the file search result content. See the
    ...
    fun createRun(
        ...
        include: kotlin.collections.List<IncludeCreateRun>? = null,
    ): RunObject {
        val localVarResponse =
            createRunWithHttpInfo(
                threadId = threadId,
                createRunRequest = createRunRequest,
                include = include,
            )
    ...
    fun createRunWithHttpInfo(
        threadId: kotlin.String,
        createRunRequest: CreateRunRequest,
        include: kotlin.collections.List<IncludeCreateRun>?,
    ): ApiResponse<RunObject?> {
        val localVariableConfig =
            createRunRequestConfig(
                threadId = threadId,
                createRunRequest = createRunRequest,
                include = include,
            )
            ...
            mutableMapOf<
                ...
                .apply {
                    if (include != null) {
                        put(
                            "include[]",
                            toMultiValue(include.toList(), "multi"),
                        )
                    }
                }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    fun createThread(
        ...
        val localVarResponse =
            createThreadWithHttpInfo(createThreadRequest = createThreadRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ThreadObject
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun createThreadWithHttpInfo(
        ...
        val localVariableConfig =
            createThreadRequestConfig(createThreadRequest = createThreadRequest)
    ...
    fun createThreadAndRun(
        ...
        val localVarResponse =
            createThreadAndRunWithHttpInfo(
                createThreadAndRunRequest = createThreadAndRunRequest
            )
    ...
    fun createThreadAndRunWithHttpInfo(
        ...
        val localVariableConfig =
            createThreadAndRunRequestConfig(
                createThreadAndRunRequest = createThreadAndRunRequest
            )
    ...
    fun deleteAssistant(assistantId: kotlin.String): DeleteAssistantResponse {
        val localVarResponse =
            deleteAssistantWithHttpInfo(assistantId = assistantId)

        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as DeleteAssistantResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun deleteAssistantWithHttpInfo(
        ...
        val localVariableConfig =
            deleteAssistantRequestConfig(assistantId = assistantId)
     ...
     * @return RequestConfig
     */
    fun deleteAssistantRequestConfig(
        assistantId: kotlin.String
    ): RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        ...
        return RequestConfig(
            ...
            path =
                "/assistants/{assistant_id}"
                    .replace(
                        "{" + "assistant_id" + "}",
                        encodeURIComponent(assistantId.toString()),
                    ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
    ...
    fun deleteMessage(
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as DeleteMessageResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun deleteMessageWithHttpInfo(
        ...
        return request<Unit, DeleteMessageResponse>(localVariableConfig)
    }
     ...
     * @return RequestConfig
     */
    fun deleteMessageRequestConfig(
        threadId: kotlin.String,
        messageId: kotlin.String,
    ): RequestConfig<Unit> {
        val localVariableBody = null
        ...
        return RequestConfig(
            ...
            path =
                "/threads/{thread_id}/messages/{message_id}"
                    ...
                    .replace(
                        "{" + "message_id" + "}",
                        encodeURIComponent(messageId.toString()),
                    ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
    ...
    fun deleteThread(threadId: kotlin.String): DeleteThreadResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as DeleteThreadResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun getAssistant(assistantId: kotlin.String): AssistantObject {
        val localVarResponse =
            getAssistantWithHttpInfo(assistantId = assistantId)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAssistantWithHttpInfo(
        assistantId: kotlin.String
    ): ApiResponse<AssistantObject?> {
        val localVariableConfig =
            getAssistantRequestConfig(assistantId = assistantId)
    ...
    fun getMessage(
        ...
        val localVarResponse =
            getMessageWithHttpInfo(threadId = threadId, messageId = messageId)
    ...
    fun getMessageWithHttpInfo(
        ...
        val localVariableConfig =
            getMessageRequestConfig(threadId = threadId, messageId = messageId)
    ...
    fun getRun(threadId: kotlin.String, runId: kotlin.String): RunObject {
        val localVarResponse =
            getRunWithHttpInfo(threadId = threadId, runId = runId)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRunWithHttpInfo(
        threadId: kotlin.String,
        runId: kotlin.String,
    ): ApiResponse<RunObject?> {
        val localVariableConfig =
            getRunRequestConfig(threadId = threadId, runId = runId)
    ...
    fun getRunStep(
        ...
        include: kotlin.collections.List<IncludeGetRunStep>? = null,
    ): RunStepObject {
        val localVarResponse =
            getRunStepWithHttpInfo(
                threadId = threadId,
                runId = runId,
                stepId = stepId,
                include = include,
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as RunStepObject
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun getRunStepWithHttpInfo(
        ...
        runId: kotlin.String,
        stepId: kotlin.String,
        include: kotlin.collections.List<IncludeGetRunStep>?,
    ): ApiResponse<RunStepObject?> {
        val localVariableConfig =
            getRunStepRequestConfig(
                threadId = threadId,
                runId = runId,
                stepId = stepId,
                include = include,
        ...
        return RequestConfig(
            ...
            path =
                "/threads/{thread_id}/runs/{run_id}/steps/{step_id}"
                    ...
                    .replace(
                        "{" + "step_id" + "}",
                        encodeURIComponent(stepId.toString()),
                    ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
    ...
    fun listAssistants(
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ListAssistantsResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun listMessages(
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ListMessagesResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun listRunSteps(
        ...
        after: kotlin.String? = null,
        before: kotlin.String? = null,
        include: kotlin.collections.List<IncludeListRunSteps>? = null,
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ListRunStepsResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
    ...
    fun listRunStepsWithHttpInfo(
        ...
        after: kotlin.String?,
        before: kotlin.String?,
        include: kotlin.collections.List<IncludeListRunSteps>?,
    ...
    fun listRuns(
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ListRunsResponse
            ResponseType.Informational ->
                throw UnsupportedOperationException(
                    "Client does not support Informational responses."
                )
