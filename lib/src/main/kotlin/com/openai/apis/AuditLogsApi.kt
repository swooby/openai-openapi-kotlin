...
class AuditLogsApi(
     ...
     * @param eventTypes Return only events with a &#x60;type&#x60; in one of
     *   these values. For example, &#x60;project.created&#x60;. For all
     *   options, see the documentation for the
     *   [audit log object](/docs/api-reference/audit-logs/object). (optional)
     * @param actorIds Return only events performed by these actors. Can be a
     *   user ID, a service account ID, or an api key tracking ID. (optional)
     * @param actorEmails Return only events performed by users with these
     *   emails. (optional)
     * @param resourceIds Return only events performed on these targets. For
     *   example, a project ID updated. (optional)
    ...
    fun listAuditLogs(
        effectiveAt: ListAuditLogsEffectiveAtParameter? = null,
        projectIds: kotlin.collections.List<kotlin.String>? = null,
        eventTypes: kotlin.collections.List<AuditLogEventType>? = null,
        actorIds: kotlin.collections.List<kotlin.String>? = null,
        actorEmails: kotlin.collections.List<kotlin.String>? = null,
        resourceIds: kotlin.collections.List<kotlin.String>? = null,
        limit: kotlin.Int? = 20,
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success ->
                (localVarResponse as Success<*>).data as ListAuditLogsResponse
    ...
    fun listAuditLogsWithHttpInfo(
        ...
        eventTypes: kotlin.collections.List<AuditLogEventType>?,
        actorIds: kotlin.collections.List<kotlin.String>?,
        actorEmails: kotlin.collections.List<kotlin.String>?,
        resourceIds: kotlin.collections.List<kotlin.String>?,
        limit: kotlin.Int?,
        after: kotlin.String?,
        before: kotlin.String?,
    ): ApiResponse<ListAuditLogsResponse?> {
        val localVariableConfig =
            listAuditLogsRequestConfig(
                effectiveAt = effectiveAt,
                projectIds = projectIds,
                eventTypes = eventTypes,
                actorIds = actorIds,
        ...
        return request<Unit, ListAuditLogsResponse>(localVariableConfig)
    }
            ...
            mutableMapOf<
                ...
                .apply {
                    ...
                    if (eventTypes != null) {
                        put(
                            "event_types[]",
                            toMultiValue(eventTypes.toList(), "multi"),
                        )
                    }
                    if (actorIds != null) {
                        put(
                            "actor_ids[]",
                            toMultiValue(actorIds.toList(), "multi"),
                        )
                    }
                    if (actorEmails != null) {
                        put(
                            "actor_emails[]",
                            toMultiValue(actorEmails.toList(), "multi"),
                        )
                    }
                    if (resourceIds != null) {
                        put(
                            "resource_ids[]",
                            toMultiValue(resourceIds.toList(), "multi"),
                        )
                    }
                    if (limit != null) {
