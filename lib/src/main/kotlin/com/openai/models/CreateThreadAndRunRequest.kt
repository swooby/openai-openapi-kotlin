 ...
 * @param thread
 * @param model
 * @param instructions Override the default system message of the assistant.
...
data class CreateThreadAndRunRequest(
    ...
    @Json(name = "thread") val thread: CreateThreadRequest? = null,
    @Json(name = "model") val model: CreateThreadAndRunRequestModel? = null,
    ...
    @Json(name = "tools")
    val tools: kotlin.collections.List<CreateThreadAndRunRequestToolsInner>? =
        null,
