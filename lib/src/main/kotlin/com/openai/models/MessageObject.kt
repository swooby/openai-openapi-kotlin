 ...
 * @param createdAt The Unix timestamp (in seconds) for when the message was
 *   created.
 * @param threadId The [thread](/docs/api-reference/threads) ID that this
 *   message belongs to.
 * @param status The status of the message, which can be either `in_progress`,
 *   `incomplete`, or `completed`.
 * @param incompleteDetails
 * @param completedAt The Unix timestamp (in seconds) for when the message was
 *   completed.
 * @param incompleteAt The Unix timestamp (in seconds) for when the message was
 *   marked as incomplete.
 * @param role The entity that produced the message. One of `user` or
 *   `assistant`.
 * @param content The content of the message in array of text and/or images.
 * @param assistantId If applicable, the ID of the
 *   [assistant](/docs/api-reference/assistants) that authored this message.
 * @param runId The ID of the [run](/docs/api-reference/runs) associated with
...
data class MessageObject(
    ...
    @Json(name = "object") val `object`: MessageObject.`Object`,
    ...
    @Json(name = "status") val status: MessageObject.Status,
    ...
    @Json(name = "incomplete_at") val incompleteAt: kotlin.Int?,

    /* The entity that produced the message. One of `user` or `assistant`. */
    @Json(name = "role") val role: MessageObject.Role,
