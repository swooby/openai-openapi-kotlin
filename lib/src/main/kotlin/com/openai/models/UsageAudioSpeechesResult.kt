...
data class UsageAudioSpeechesResult(
    @Json(name = "object") val `object`: UsageAudioSpeechesResult.`Object`,
    ...
    enum class `Object`(val value: kotlin.String) {
        @Json(name = "organization.usage.audio_speeches.result")
        organizationPeriodUsagePeriodAudio_speechesPeriodResult(
