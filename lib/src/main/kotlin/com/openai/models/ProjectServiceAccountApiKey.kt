...
data class ProjectServiceAccountApiKey(
    ...
    @Json(name = "object") val `object`: ProjectServiceAccountApiKey.`Object`,
    ...
    enum class `Object`(val value: kotlin.String) {
        @Json(name = "organization.project.service_account.api_key")
        organizationPeriodProjectPeriodService_accountPeriodApi_key(
            "organization.project.service_account.api_key"
        )
    }
}
