 ...
 * @param source When `group_by=source`, this field provides the source of the
 *   grouped usage result, possible values are `image.generation`, `image.edit`,
 *   `image.variation`.
 * @param propertySize When `group_by=size`, this field provides the image size
 *   of the grouped usage result.
 * @param numSessions The number of code interpreter sessions.
 * @param amount
 * @param lineItem When `group_by=line_item`, this field provides the line item
 *   of the grouped costs result.
 */
data class UsageTimeBucketResultInner(
    @Json(name = "object") val `object`: UsageTimeBucketResultInner.`Object`,
    ...
    @Json(name = "images") val images: kotlin.Int,

    /* The number of characters processed. */
    @Json(name = "characters") val characters: kotlin.Int,

    /* The number of seconds processed. */
    @Json(name = "seconds") val seconds: kotlin.Int,
    ...
    @Json(name = "num_sessions") val numSessions: kotlin.Int? = null,
    @Json(name = "amount") val amount: CostsResultAmount? = null,

    /* When `group_by=line_item`, this field provides the line item of the grouped costs result. */
    @Json(name = "line_item") val lineItem: kotlin.String? = null,
) {

    /** Values: organizationPeriodCostsPeriodResult */
    @JsonClass(generateAdapter = false)
    enum class `Object`(val value: kotlin.String) {
        @Json(name = "organization.costs.result")
