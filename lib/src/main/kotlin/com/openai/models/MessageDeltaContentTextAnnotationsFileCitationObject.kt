 ...
 * File associated with the assistant or the message. Generated when the
 * assistant uses the \"file_search\" tool to search files.
 *
...
data class MessageDeltaContentTextAnnotationsFileCitationObject(
    ...
    val fileCitation:
        ...
        null,
    @Json(name = "start_index") val startIndex: kotlin.Int? = null,
    @Json(name = "end_index") val endIndex: kotlin.Int? = null,
) {
