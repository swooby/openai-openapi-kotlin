 ...
 * @param acceptedAt The Unix timestamp (in seconds) of when the invite was
 *   accepted.
 * @param projects The projects that were granted membership upon acceptance of
 *   the invite.
 */
data class Invite(

    /* The object type, which is always `organization.invite` */
    @Json(name = "object") val `object`: Invite.`Object`,
    ...
    /* `owner` or `reader` */
    @Json(name = "role") val role: Invite.Role,

    /* `accepted`,`expired`, or `pending` */
    @Json(name = "status") val status: Invite.Status,

    /* The Unix timestamp (in seconds) of when the invite was sent. */
    @Json(name = "invited_at") val invitedAt: kotlin.Int,

    /* The Unix timestamp (in seconds) of when the invite expires. */
    @Json(name = "expires_at") val expiresAt: kotlin.Int,

    /* The Unix timestamp (in seconds) of when the invite was accepted. */
    @Json(name = "accepted_at") val acceptedAt: kotlin.Int? = null,
