 ...
 * @param purpose The intended purpose of the uploaded file. See the
 ...
 * @param mimeType The MIME type of the file. This must fall within the
 *   supported MIME types for your file purpose. See the supported MIME types
...
data class CreateUploadRequest(
    ...
    @Json(name = "purpose") val purpose: CreateUploadRequest.Purpose,
    ...
    /**
     * The intended purpose of the uploaded file. See the
     * [documentation on File purposes](/docs/api-reference/files/create#files-create-purpose).
     *
