 ...
 * @param description The description of the function, including guidance on
 *   when and how to call it, and guidance about what to tell the user when
 *   calling (if anything).
...
data class RealtimeResponseCreateParamsToolsInner(
    ...
    @Json(name = "parameters") val parameters: kotlin.Any? = null,
) {
