 ...
 * @param outputs The outputs from the Code Interpreter tool call. Code
 *   Interpreter can output one or more items, including text (`logs`) or images
...
data class RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter(
    ...
    @Json(name = "input") val input: kotlin.String? = null,
