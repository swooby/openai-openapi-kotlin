...
/**
 * @param prompt A text description of the desired image(s). The maximum length
 ...
 * @param quality The quality of the image that will be generated. `hd` creates
 ...
 * @param propertySize The size of the generated images. Must be one of
 *   `256x256`, `512x512`, or `1024x1024` for `dall-e-2`. Must be one of
 *   `1024x1024`, `1792x1024`, or `1024x1792` for `dall-e-3` models.
 * @param style The style of the generated images. Must be one of `vivid` or
...
data class CreateImageRequest(
    ...
    @Json(name = "prompt") val prompt: kotlin.String,
    @Json(name = "model") val model: CreateImageRequestModel? = null,
    ...
    @Json(name = "size")
    val propertySize: CreateImageRequest.PropertySize? =
        PropertySize._1024x1024,

    /* The style of the generated images. Must be one of `vivid` or `natural`. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images. This param is only supported for `dall-e-3`. */
    @Json(name = "style") val style: CreateImageRequest.Style? = Style.vivid,
