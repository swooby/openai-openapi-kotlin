...
/**
 * @param fileId The [File](/docs/api-reference/files) ID of the image in the
 *   message content. Set `purpose=\"vision\"` when uploading the File if you
 *   need to later display the file content.
 * @param detail Specifies the detail level of the image if specified by the
...
data class MessageDeltaContentImageFileObjectImageFile(
    ...
    @Json(name = "detail")
    val detail: MessageDeltaContentImageFileObjectImageFile.Detail? =
        Detail.auto,
) {
