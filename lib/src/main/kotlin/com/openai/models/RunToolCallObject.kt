 ...
 *   the tool outputs in using the
 *   [Submit tool outputs to run](/docs/api-reference/runs/submitToolOutputs)
 *   endpoint.
 * @param type The type of tool call the output is required for. For now, this
 *   is always `function`.
 * @param function
 */
data class RunToolCallObject(
    ...
    @Json(name = "type") val type: RunToolCallObject.Type,
    @Json(name = "function") val function: RunToolCallObjectFunction,
) {
