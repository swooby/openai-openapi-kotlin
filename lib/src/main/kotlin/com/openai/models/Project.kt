 ...
 * @param createdAt The Unix timestamp (in seconds) of when the project was
 *   created.
 * @param status `active` or `archived`
 * @param archivedAt The Unix timestamp (in seconds) of when the project was
 *   archived or `null`.
 */
data class Project(
    ...
    @Json(name = "object") val `object`: Project.`Object`,
    ...
    /* `active` or `archived` */
    @Json(name = "status") val status: Project.Status,

    /* The Unix timestamp (in seconds) of when the project was archived or `null`. */
    @Json(name = "archived_at") val archivedAt: kotlin.Int? = null,
) {
    ...
    enum class `Object`(val value: kotlin.String) {
        @Json(name = "organization.project")
