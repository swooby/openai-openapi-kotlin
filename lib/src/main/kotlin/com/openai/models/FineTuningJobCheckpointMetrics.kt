...
data class FineTuningJobCheckpointMetrics(
    @Json(name = "step") val step: java.math.BigDecimal? = null,
    @Json(name = "train_loss") val trainLoss: java.math.BigDecimal? = null,
    @Json(name = "train_mean_token_accuracy")
    val trainMeanTokenAccuracy: java.math.BigDecimal? = null,
    @Json(name = "valid_loss") val validLoss: java.math.BigDecimal? = null,
