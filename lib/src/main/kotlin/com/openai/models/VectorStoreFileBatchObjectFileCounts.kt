...
data class VectorStoreFileBatchObjectFileCounts(
    ...
    @Json(name = "in_progress") val inProgress: kotlin.Int,

    /* The number of files that have been processed. */
    @Json(name = "completed") val completed: kotlin.Int,

    /* The number of files that have failed to process. */
    @Json(name = "failed") val failed: kotlin.Int,

    /* The number of files that where cancelled. */
    @Json(name = "cancelled") val cancelled: kotlin.Int,

    /* The total number of files. */
    @Json(name = "total") val total: kotlin.Int,
) {}
