...
class RealtimeSessionMaxResponseOutputTokensAdapter :
    JsonAdapter<RealtimeSessionMaxResponseOutputTokens>() {
    @FromJson
        ...
        return when (reader.peek()) {
            ...
            JsonReader.Token.STRING -> {
                ...
                if (value == "inf") {
                    ...
                    // you might consider throwing or returning null for an
                    // unrecognized string.
                    throw JsonDataException(
                        "Unknown string for max_response_output_tokens: $value"
                    )
                }
            }
    ...
    override fun toJson(
        ...
        when (value) {
            is RealtimeSessionMaxResponseOutputTokens.Numeric ->
