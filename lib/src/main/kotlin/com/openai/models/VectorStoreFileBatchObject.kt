 ...
 * @param status The status of the vector store files batch, which can be either
...
data class VectorStoreFileBatchObject(
    ...
    @Json(name = "object") val `object`: VectorStoreFileBatchObject.`Object`,
    ...
    @Json(name = "status") val status: VectorStoreFileBatchObject.Status,
    ...
    enum class `Object`(val value: kotlin.String) {
        @Json(name = "vector_store.files_batch")
