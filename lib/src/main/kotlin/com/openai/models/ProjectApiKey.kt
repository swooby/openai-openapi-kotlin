 ...
 * @param createdAt The Unix timestamp (in seconds) of when the API key was
 *   created
...
data class ProjectApiKey(
    ...
    @Json(name = "object") val `object`: ProjectApiKey.`Object`,

    /* The redacted value of the API key */
    @Json(name = "redacted_value") val redactedValue: kotlin.String,
    ...
    @Json(name = "owner") val owner: ProjectApiKeyOwner,
) {
    ...
    enum class `Object`(val value: kotlin.String) {
        @Json(name = "organization.project.api_key")
