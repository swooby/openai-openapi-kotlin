 ...
 * @param createdAt The Unix timestamp (in seconds) for when the run was
 *   created.
 * @param threadId The ID of the [thread](/docs/api-reference/threads) that was
 *   executed on as a part of this run.
 * @param assistantId The ID of the [assistant](/docs/api-reference/assistants)
 *   used for execution of this run.
 * @param status The status of the run, which can be either `queued`,
 *   `in_progress`, `requires_action`, `cancelling`, `cancelled`, `failed`,
 *   `completed`, `incomplete`, or `expired`.
 * @param requiredAction
 * @param lastError
 * @param expiresAt The Unix timestamp (in seconds) for when the run will
 *   expire.
 * @param startedAt The Unix timestamp (in seconds) for when the run was
 *   started.
 * @param cancelledAt The Unix timestamp (in seconds) for when the run was
 *   cancelled.
 * @param failedAt The Unix timestamp (in seconds) for when the run failed.
 * @param completedAt The Unix timestamp (in seconds) for when the run was
 *   completed.
 * @param incompleteDetails
 * @param model The model that the [assistant](/docs/api-reference/assistants)
 *   used for this run.
 * @param instructions The instructions that the
 *   [assistant](/docs/api-reference/assistants) used for this run.
 * @param tools The list of tools that the
 *   [assistant](/docs/api-reference/assistants) used for this run.
 ...
 * @param usage
 * @param maxPromptTokens The maximum number of prompt tokens specified to have
 *   been used over the course of the run.
 * @param maxCompletionTokens The maximum number of completion tokens specified
 *   to have been used over the course of the run.
 ...
 * @param temperature The sampling temperature used for this run. If not set,
 *   defaults to 1.
 * @param topP The nucleus sampling value used for this run. If not set,
 *   defaults to 1.
 */
data class RunObject(
    ...
    @Json(name = "object") val `object`: RunObject.`Object`,

    /* The Unix timestamp (in seconds) for when the run was created. */
    @Json(name = "created_at") val createdAt: kotlin.Int,

    /* The ID of the [thread](/docs/api-reference/threads) that was executed on as a part of this run. */
    @Json(name = "thread_id") val threadId: kotlin.String,

    /* The ID of the [assistant](/docs/api-reference/assistants) used for execution of this run. */
    @Json(name = "assistant_id") val assistantId: kotlin.String,

    /* The status of the run, which can be either `queued`, `in_progress`, `requires_action`, `cancelling`, `cancelled`, `failed`, `completed`, `incomplete`, or `expired`. */
    @Json(name = "status") val status: RunObject.Status,
    @Json(name = "required_action")
    val requiredAction: RunObjectRequiredAction?,
    @Json(name = "last_error") val lastError: RunObjectLastError?,

    /* The Unix timestamp (in seconds) for when the run will expire. */
    @Json(name = "expires_at") val expiresAt: kotlin.Int?,

    /* The Unix timestamp (in seconds) for when the run was started. */
    @Json(name = "started_at") val startedAt: kotlin.Int?,

    /* The Unix timestamp (in seconds) for when the run was cancelled. */
    @Json(name = "cancelled_at") val cancelledAt: kotlin.Int?,

    /* The Unix timestamp (in seconds) for when the run failed. */
    @Json(name = "failed_at") val failedAt: kotlin.Int?,

    /* The Unix timestamp (in seconds) for when the run was completed. */
    @Json(name = "completed_at") val completedAt: kotlin.Int?,
    ...
    @Json(name = "usage") val usage: RunCompletionUsage?,

    /* The maximum number of prompt tokens specified to have been used over the course of the run.  */
    @Json(name = "max_prompt_tokens") val maxPromptTokens: kotlin.Int?,

    /* The maximum number of completion tokens specified to have been used over the course of the run.  */
    @Json(name = "max_completion_tokens") val maxCompletionTokens: kotlin.Int?,
    @Json(name = "truncation_strategy")
    val truncationStrategy: CreateRunRequestTruncationStrategy,
    @Json(name = "tool_choice") val toolChoice: CreateRunRequestToolChoice,
    ...
    @Json(name = "top_p") val topP: java.math.BigDecimal? = null,
) {
