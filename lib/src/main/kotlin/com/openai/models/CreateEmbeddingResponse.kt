...
data class CreateEmbeddingResponse(
    ...
    @Json(name = "data") val `data`: kotlin.collections.List<Embedding>,

    /* The name of the model used to generate the embedding. */
    @Json(name = "model") val model: kotlin.String,

    /* The object type, which is always \"list\". */
    @Json(name = "object") val `object`: CreateEmbeddingResponse.`Object`,
    @Json(name = "usage") val usage: CreateEmbeddingResponseUsage,
) {
