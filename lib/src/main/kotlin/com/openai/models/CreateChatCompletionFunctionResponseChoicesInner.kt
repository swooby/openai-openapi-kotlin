 ...
 *   be `stop` if the model hit a natural stop point or a provided stop
 ...
 *   content filters, or `function_call` if the model called a function.
...
data class CreateChatCompletionFunctionResponseChoicesInner(
    ...
    val finishReason:
        CreateChatCompletionFunctionResponseChoicesInner.FinishReason,

    /* The index of the choice in the list of choices. */
    @Json(name = "index") val index: kotlin.Int,
    @Json(name = "message") val message: ChatCompletionResponseMessage,
) {
