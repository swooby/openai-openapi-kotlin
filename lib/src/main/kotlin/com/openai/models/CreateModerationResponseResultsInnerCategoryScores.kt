...
data class CreateModerationResponseResultsInnerCategoryScores(
    ...
    @Json(name = "hate") val hate: java.math.BigDecimal,

    /* The score for the category 'hate/threatening'. */
    @Json(name = "hate/threatening") val hateThreatening: java.math.BigDecimal,

    /* The score for the category 'harassment'. */
    @Json(name = "harassment") val harassment: java.math.BigDecimal,
    ...
    @Json(name = "illicit") val illicit: java.math.BigDecimal,

    /* The score for the category 'illicit/violent'. */
    @Json(name = "illicit/violent") val illicitViolent: java.math.BigDecimal,

    /* The score for the category 'self-harm'. */
    @Json(name = "self-harm") val selfHarm: java.math.BigDecimal,

    /* The score for the category 'self-harm/intent'. */
    @Json(name = "self-harm/intent") val selfHarmIntent: java.math.BigDecimal,
    ...
    @Json(name = "sexual") val sexual: java.math.BigDecimal,

    /* The score for the category 'sexual/minors'. */
    @Json(name = "sexual/minors") val sexualMinors: java.math.BigDecimal,

    /* The score for the category 'violence'. */
    @Json(name = "violence") val violence: java.math.BigDecimal,

    /* The score for the category 'violence/graphic'. */
    @Json(name = "violence/graphic") val violenceGraphic: java.math.BigDecimal,
) {}
