 ...
 * @param choices A list of chat completion choices. Can be more than one if `n`
 *   is greater than 1.
...
data class CreateChatCompletionResponse(
    ...
    @Json(name = "choices")
    val choices:
        kotlin.collections.List<CreateChatCompletionResponseChoicesInner>,
    ...
    @Json(name = "object") val `object`: CreateChatCompletionResponse.`Object`,
