 ...
 * @param include Specify additional output data to include in the model
 *   response. Currently supported values are: - `file_search_call.results`:
 *   Include the search results of the file search tool call. -
 *   `message.input_image.image_url`: Include image urls from the input
 *   message. - `computer_call_output.output.image_url`: Include image urls from
 *   the computer call output.
 * @param parallelToolCalls Whether to allow the model to run tool calls in
 *   parallel.
 * @param store Whether to store the generated model response for later
 *   retrieval via API.
...
data class CreateResponse(
    ...
    @Json(name = "input") val input: CreateResponseAllOfInput,
    ...
    val truncation: CreateResponse.Truncation? = Truncation.disabled,
    ...
    @Json(name = "include")
    val include: kotlin.collections.List<Includable>? = null,
    ...
    @Json(name = "store") val store: kotlin.Boolean? = true,
