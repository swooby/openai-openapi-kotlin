 ...
 * @param usageBytes The total number of bytes used by the files in the vector
 *   store.
 * @param fileCounts
 * @param status The status of the vector store, which can be either `expired`,
 *   `in_progress`, or `completed`. A status of `completed` indicates that the
 *   vector store is ready for use.
 * @param lastActiveAt The Unix timestamp (in seconds) for when the vector store
 *   was last active.
 ...
 * @param expiresAfter
 * @param expiresAt The Unix timestamp (in seconds) for when the vector store
 *   will expire.
 */
data class VectorStoreObject(
    ...
    @Json(name = "object") val `object`: VectorStoreObject.`Object`,
    ...
    @Json(name = "file_counts") val fileCounts: VectorStoreObjectFileCounts,

    /* The status of the vector store, which can be either `expired`, `in_progress`, or `completed`. A status of `completed` indicates that the vector store is ready for use. */
    @Json(name = "status") val status: VectorStoreObject.Status,

    /* The Unix timestamp (in seconds) for when the vector store was last active. */
    @Json(name = "last_active_at") val lastActiveAt: kotlin.Int?,
