...
data class AuditLog(
    ...
    @Json(name = "type") val type: AuditLogEventType,

    /* The Unix timestamp (in seconds) of the event. */
    @Json(name = "effective_at") val effectiveAt: kotlin.Int,
    @Json(name = "actor") val actor: AuditLogActor,
    @Json(name = "project") val project: AuditLogProject? = null,
    ...
    @Json(name = "invite.sent") val inviteSent: AuditLogInviteSent? = null,
    ...
    @Json(name = "login.failed") val loginFailed: AuditLogLoginFailed? = null,
    @Json(name = "logout.failed") val logoutFailed: AuditLogLoginFailed? = null,
    ...
    @Json(name = "user.added") val userAdded: AuditLogUserAdded? = null,
    @Json(name = "user.updated") val userUpdated: AuditLogUserUpdated? = null,
    @Json(name = "user.deleted") val userDeleted: AuditLogUserDeleted? = null,
) {}
