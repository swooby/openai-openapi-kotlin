...
data class RunStepStreamEventOneOf1(
    @Json(name = "event") val event: RunStepStreamEventOneOf1.Event,
    @Json(name = "data") val `data`: RunStepObject,
) {

    /** Values: threadPeriodRunPeriodStepPeriodIn_progress */
    @JsonClass(generateAdapter = false)
    enum class Event(val value: kotlin.String) {
        @Json(name = "thread.run.step.in_progress")
        threadPeriodRunPeriodStepPeriodIn_progress(
