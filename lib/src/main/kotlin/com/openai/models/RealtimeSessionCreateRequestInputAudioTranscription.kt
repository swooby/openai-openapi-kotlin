 ...
 * understood by the model. The client can optionally set the language and
 * prompt for transcription, these fields will be passed to the Whisper API.
 *
...
data class RealtimeSessionCreateRequestInputAudioTranscription(
    ...
    @Json(name = "model")
    val model: RealtimeSessionCreateRequestInputAudioTranscription.Model? =
        null,
