...
enum class AssistantSupportedModels(val value: kotlin.String) {
    ...
    @Json(name = "o1-2024-12-17")
    o1Minus2024Minus12Minus17("o1-2024-12-17"),
    ...
    @Json(name = "gpt-4-0314")
    gptMinus4Minus0314("gpt-4-0314"),

    @Json(name = "gpt-4-0613")
    gptMinus4Minus0613("gpt-4-0613"),

    @Json(name = "gpt-4-32k")
    gptMinus4Minus32k("gpt-4-32k"),

    @Json(name = "gpt-4-32k-0314")
    gptMinus4Minus32kMinus0314("gpt-4-32k-0314"),

    @Json(name = "gpt-4-32k-0613")
    gptMinus4Minus32kMinus0613("gpt-4-32k-0613"),

    @Json(name = "gpt-3.5-turbo")
    gptMinus3Period5MinusTurbo("gpt-3.5-turbo"),
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AssistantSupportedModels) "$data" else null

        /**
         * Returns a valid [AssistantSupportedModels] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): AssistantSupportedModels? = data?.let {
