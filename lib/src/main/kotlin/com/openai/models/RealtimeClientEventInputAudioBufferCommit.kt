 ...
 * automatically. Committing the input audio buffer will trigger input audio
 * transcription (if enabled in session configuration), but it will not create a
 * response from the model. The server will respond with an
