...
enum class TranscriptionInclude(val value: kotlin.String) {

    @Json(name = "logprobs") logprobs("logprobs");
    ...
    companion object {
        ...
        fun encode(data: kotlin.Any?): kotlin.String? =
            if (data is TranscriptionInclude) "$data" else null

        /**
         * Returns a valid [TranscriptionInclude] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): TranscriptionInclude? =
            data?.let {
