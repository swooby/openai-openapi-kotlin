 ...
 *
 * @param id The Upload unique identifier, which can be referenced in API
 *   endpoints.
 * @param createdAt The Unix timestamp (in seconds) for when the Upload was
 *   created.
...
data class Upload(
    ...
    @Json(name = "purpose") val purpose: kotlin.String,
    ...
    @Json(name = "object") val `object`: Upload.`Object`? = null,
    @Json(name = "file") val file: UploadFile? = null,
) {
